...
7. Use [`docs/policy-integrity-self-assessment.md`](docs/policy-integrity-self-assessment.md) for a deeper workflow-level assessment before expanding autonomy.
