...
This file provides a detailed navigation map for the repository.

The main `README.md` is intentionally kept shorter as the public front door. Use this map when you want to browse the project by area.
...
- [`docs/core-concepts-bundle.md`](core-concepts-bundle.md)
- [`docs/raba-clarity-map.md`](raba-clarity-map.md)
- [`docs/raba-in-one-example.md`](raba-in-one-example.md)
- [`docs/raba-lite-15-minute-check.md`](raba-lite-15-minute-check.md)
...
- [`docs/external-ai-suggestion-intake.md`](external-ai-suggestion-intake.md)
...
AI-assisted reviews can also produce structured improvement suggestions through [`docs/ai-contribution-intake.md`](ai-contribution-intake.md). External reviewers can use [`docs/external-ai-suggestion-intake.md`](external-ai-suggestion-intake.md) to understand why and how to submit those recommendations.
...
- [`docs/project-intent.md`](project-intent.md)
- [`docs/project-development-tracks.md`](project-development-tracks.md)
- [`docs/evolution/from-control-to-coordination.md`](evolution/from-control-to-coordination.md)
- [`docs/evolution-from-control-to-coexistence.md`](evolution-from-control-to-coexistence.md)
